...
if (!class_exists('Drupal\Core\DefaultContent\Exporter')) {
  ...
  final class Exporter implements LoggerAwareInterface {
    ...
    private function exportFieldItem(FieldItemInterface $item): array {
      $reflector = new \ReflectionMethod(Importer::class, 'getCustomSerializedPropertyNames');
      $custom_serialized = $reflector->invoke(\Drupal::service(Importer::class), $item);
  ...
  final readonly class ExportResult {
    ...
    public function __toString(): string {
      ...
      return \Drupal\Core\Serialization\Yaml::encode($data);
    }
